...
const GUIDELINES = [
  ...
  },
  {
    ...
    body: "The \u201cTrade with Escrow\u201d button on any listing walks you through Threddo Escrow: admin holds the buyer's payment in a shared WhatsApp group until the buyer confirms the item has arrived as described, then releases the funds to the seller. A 5% fee is sent as part of the payment to admin, and is returned if the deal falls through."
  },
  {
